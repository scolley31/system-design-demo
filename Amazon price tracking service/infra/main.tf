...
module "compute" {
  ...
  price_table_name            = module.data.price_table_name
  price_table_arn             = module.data.price_table_arn
  price_stream_arn            = module.data.price_stream_arn
  amazon_domain               = var.amazon_domain
  crawl_rps                   = var.crawl_rps
  ses_from_email              = var.ses_from_email
  suspicious_drop_pct         = var.suspicious_drop_pct
  min_change_pct              = var.min_change_pct
}
...
module "cleanup" {
  ...
  outbox_retention_days    = var.outbox_retention_days
  crawl_log_retention_days = var.crawl_log_retention_days
